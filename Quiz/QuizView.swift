...
struct QuizView: View {
    ...
    let quizzes = [
        ...
        QuizData(
            ...
            description: "Test your understanding of the Big Bang and universe evolution",
            questions: 13,
            difficulty: "Advanced",
            timeEstimate: "15 min",
            category: "Cosmology"
        ...
        QuizData(
            id: "nebulae",
            title: "Nebulae Quiz",
            description: "Learn about stellar nurseries and cosmic clouds",
            questions: 13,
            difficulty: "Intermediate",
            timeEstimate: "15 min",
            category: "Nebulae"
        ...
        QuizData(
            id: "asteroids",
            title: "Asteroids & Comets Quiz",
            description: "Test your knowledge of rocky and icy remnants",
            questions: 13,
            difficulty: "Beginner",
            timeEstimate: "15 min",
            category: "Asteroids"
        ...
        QuizData(
            ...
            description: "Discover humanity's journey into space",
            questions: 13,
            difficulty: "Beginner",
            timeEstimate: "15 min",
    ...
    var body: some View {
        ZStack {
            ...
            if isQuizActive {
                ...
                .id(selectedQuizId ?? "demo") // Reset scroll position when quiz changes
        ...
        .onAppear {
            // Auto-start quiz if initialQuizId is provided
            if let initialId = initialQuizId {
                selectedQuizId = initialId
                isQuizActive = true
            }
        }
    }
    ...
    private var demoQuizButton: some View {
        Button(action: {
            selectedQuizId = nil // Use demo questions
            isQuizActive = true
        }) {
            HStack {
