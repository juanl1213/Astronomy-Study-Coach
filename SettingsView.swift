            ...
            VStack(spacing: Spacing.lg) {
                VStack(alignment: .leading, spacing: Spacing.sm) {
                    ...
                    HStack(spacing: Spacing.md) {
                        ThemeOption(icon: "sun.max.fill", title: "Light", isSelected: themeManager.theme == "light") {
                            themeManager.theme = "light"
                            preferences.theme = "light"
                        }
                        
                        ThemeOption(icon: "moon.fill", title: "Dark", isSelected: themeManager.theme == "dark") {
                            themeManager.theme = "dark"
                            preferences.theme = "dark"
                        }
                        
                        ThemeOption(icon: "display", title: "System", isSelected: themeManager.theme == "system") {
